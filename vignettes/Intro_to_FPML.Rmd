...
Right now we don't really do anything with the validation data, though that is subject to change. More importantly, you don't actually have to do anything with the members of the list themselves. This exactly list is all you'll have to put in to the modeling functions to make them work. So don't sweat it!
